...
<Step title="Filter Transactions">
  Use the filter options to find specific transactions: - **Status**: Filter by transaction status
  (pending, confirmed, failed)
</Step>

<Step title="View Transaction Details">
  Each transaction displays the following information: - **Amount**: Transaction amount and currency
  - **Status**: Current transaction status - **Date**: Transaction date and time - **Chain**:
...
<Step title="View Key Metrics">
  The analytics page displays: - **Total Revenue**: Sum of all successful transactions - **Number of
  Transactions**: Total transaction count - **Customers**: Number of unique customers - **Average
...
<Step title="Change Payout Account">
  To set up a new payout account, send your bank verification documents to our support team for
  approval.
</Step>
