...
<Step title="Choose Your Integration Method">
  Select the integration approach that best fits your needs: - **SDK Integration**: Quick setup with
  built-in functionality - **API Integration**: Full control with direct API calls - **Webhooks**:
...
<Card title="API Integration" icon="terminal" href="/developer-docs/api-integration">
  **Best for**: Full control, custom UI Integrate directly with SpacePay's REST APIs to build your
...
<Accordion title="SpacePay Smart Account">
  **Features**: Top-up functionality, pre-funded payments **Benefits**: Faster checkout, reduced
  transaction fees **Best for**: Regular customers, subscription services
</Accordion>
...
<Card title="Supported chains" icon="link" href="/developer-docs/supported-chains">
