...
<Card title="Testnet Environment" icon="flask">
  ...
  **Base URL**: `https://api-testnet.spacepay.solutions`
  ...
  Supported testnet networks are listed in [Blockchain Concepts](/developer-docs/blockchain-concepts).
</Card>
...
<Card title="Mainnet Environment" icon="rocket">
  ...
  **Base URL**: `https://api.spacepay.solutions`
  ...
  Supported mainnet networks and assets are listed in [Blockchain Concepts](/developer-docs/blockchain-concepts).
</Card>
</CardGroup>
